...
const amountEl: HTMLInputElement | null =
    document.querySelector('#specular__amount');
const redEl: HTMLInputElement | null = document.querySelector('#specular__red');
const greenEl: HTMLInputElement | null =
    document.querySelector('#specular__green');
const blueEl: HTMLInputElement | null =
    document.querySelector('#specular__blue');
...
const updateLight = () => {
    ...
    store.dispatch(
        lightActions.changeSpecularLight(amount, [red, green, blue]),
    );
};
